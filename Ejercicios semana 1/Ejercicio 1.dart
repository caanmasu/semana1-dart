...
void main(){
  ...
  print((a.toSet().intersection(b.toSet()).toList())); //convierto cada lista en una colección set para quitarles los elementos repetidos. Luego busco los elementos en común con intersection.
}
